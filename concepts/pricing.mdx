...
<Tabs>
  <Tab title="OpenAI Models">
    | Model | SaveGate Price | OpenAI Direct | Savings |
    |-------|----------------|---------------|---------|
    | GPT-4 Turbo | $0.007 / 1K input<br/>$0.021 / 1K output | $0.01 / 1K input<br/>$0.03 / 1K output | **30%** |
    | GPT-4 | $0.021 / 1K input<br/>$0.042 / 1K output | $0.03 / 1K input<br/>$0.06 / 1K output | **30%** |
    | GPT-3.5 Turbo | $0.0003 / 1K input<br/>$0.0006 / 1K output | $0.0005 / 1K input<br/>$0.0015 / 1K output | **40-60%** |
  </Tab>

  <Tab title="Anthropic Models">
    | Model | SaveGate Price | Anthropic Direct | Savings |
    |-------|----------------|------------------|---------|
    | Claude 3.5 Sonnet | $0.002 / 1K input<br/>$0.010 / 1K output | $0.003 / 1K input<br/>$0.015 / 1K output | **33%** |
    | Claude 3 Opus | $0.010 / 1K input<br/>$0.050 / 1K output | $0.015 / 1K input<br/>$0.075 / 1K output | **33%** |
    | Claude 3 Haiku | $0.00018 / 1K input<br/>$0.00090 / 1K output | $0.00025 / 1K input<br/>$0.00125 / 1K output | **28%** |
  </Tab>

  <Tab title="Google Models">
    | Model | SaveGate Price | Google Direct | Savings |
    |-------|----------------|---------------|---------|
    | Gemini 1.5 Pro | $0.002 / 1K input<br/>$0.006 / 1K output | $0.0025 / 1K input<br/>$0.0075 / 1K output | **20%** |
    | Gemini 1.5 Flash | $0.00005 / 1K input<br/>$0.00015 / 1K output | $0.000075 / 1K input<br/>$0.0003 / 1K output | **33-50%** |
  </Tab>
</Tabs>

...
<AccordionGroup>
  ...
  <Accordion title="Example: Code Assistant" icon="code">
    ...
    **Calculation**
    ...
    - Input: 10,000 × 200 = 2M tokens → 2 × $0.75 = **$1.50**
    - Output: 10,000 × 300 = 3M tokens → 3 × $4.50 = **$13.50**
    - **Total: $15.00/month**
  </Accordion>
  ...
  <Accordion title="Example: Image Generation" icon="image">
    ...
    **Calculation**
    - Output: 2,000 × $0.039 = **$78.00**
    - **Total: ~$78/month**

    Generated images are billed at a flat per-image rate. Text tokens in the same
    request are billed separately at the model's normal input/output rates.
  </Accordion>
</AccordionGroup>
